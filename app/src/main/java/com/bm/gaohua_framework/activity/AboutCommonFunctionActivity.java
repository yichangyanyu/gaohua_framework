 ...
 * 
 * @Description 常用模块Demo
 * @author 高骅
 * @date 2015-5-8 下午7:35:43
 */
public class AboutCommonFunctionActivity extends Activity implements IBaseActivity {
	/**
	 * 主页数据
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_common_function);
		initData();
		initView();
	}
	...
	public void initView() {
		...
		lv_main.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				case 0:
					// 系统联系人Demo
					startActivity(new Intent(AboutCommonFunctionActivity.this, ContactsActivity.class));
					break;
				case 1:
					// 指示器Demo
	...
	public void initData() {
		...
		String menu1 = "系统联系人Demo";
		String menu2 = "指示器Demo";
		data.add(menu1);
		data.add(menu2);
